...
describe("@CreatedBy / @UpdatedBy", () => {
  describe("Given no resolveActor is defined", () => {
    ...
    beforeEach(async () => {
      app = await managedAppInstance(
        "src/no-resolver-app.module.ts#NoResolverAppModule",
      )
    })
  ...
  const resolverModules = [
    {
      label: "forRoot",
      path: "src/value-resolver-app.module.ts#ValueResolverAppModule",
    },
    {
      label: "forRootAsync",
      path: "src/value-resolver-async-app.module.ts#ValueResolverAsyncAppModule",
    },
  ]
  ...
  describe("Given a custom defaultActor is defined", () => {
    ...
    beforeEach(async () => {
      app = await managedAppInstance(
        "src/custom-default-app.module.ts#CustomDefaultAppModule",
      )
    })
